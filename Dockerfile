# Generated by ./gen-Dockerfile.sh from https://github.com/nginxinc/docker-nginx/tree/1.25.4
ARG NGINX_FROM_IMAGE=nginx:1.25.4-alpine
FROM ${NGINX_FROM_IMAGE} as builder

ARG ENABLED_MODULES="auth-spnego authldap brotli encrypted-session fips-check geoip geoip2 headers-more image-filter lua ndk rtmp set-misc subs-filter xslt"
